...
def main():
    ...
    # print('Classes')
    # for k, v in tickers_objects.items():
    #     print(f'{k}:\n{v}')
    ...
    for option in assigned_options:
        ...
        if ticker_name in tickers_objects:
            ...
            # print(tickers_objects[ticker_name])
    ...
    for line in trades_data:
        ...
        tickers_objects[ticker_name].add_transaction(current_trade_dict) #This here is a big problem!!!!!!!!!!!!!!!!!!!!!!!!
